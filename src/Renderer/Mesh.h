...
public:
    ...
    // Рендеринг mesh-а
    void Draw(RenderEngine::ShaderProgram& shader)
    {
        ...
        {
            glActiveTexture(GL_TEXTURE0 + i); //1. перед связыванием активируем нужный текстурный юнит
